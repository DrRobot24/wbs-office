...
function ChildrenList({ children, depth = 0 }) {
  ...
  return (
    <div className={`flex flex-col gap-1 ${depth > 0 ? 'ml-3 border-l border-amber-200 pl-2' : ''}`}>
      {children.map(child => {
      ...
      >
        ...
        <div className="px-4 pt-3 pb-1">
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-xs text-gray-400 font-medium">Avanzamento</span>
            <span className="text-xs font-bold text-amber-600">{nodo.percentuale}%</span>
          </div>
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="bg-white rounded-xl border border-gray-300 p-5 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm font-semibold text-gray-700">Avanzamento Globale</h2>
            <span className="text-2xl font-bold text-amber-600">{progetto.percentuale}%</span>
          </div>
              ...
              <div className="flex items-start gap-0 min-w-max px-2 py-4">
                ...
                <div className="flex items-center self-center mr-2">
                  <div className="w-10 h-10 rounded-full bg-amber-100 border-2 border-amber-400 flex items-center justify-center shadow-md">
                    <span className="text-amber-700 text-xs font-bold">START</span>
                  </div>
