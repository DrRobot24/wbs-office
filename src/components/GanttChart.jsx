    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-gray-50">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 bg-gray-50 rounded-lg border border-gray-300 px-2 py-1">
              ...
              <select
                ...
                className="text-[11px] bg-transparent text-gray-600 cursor-pointer focus:outline-none"
              >
      ...
      {righe.length === 0 ? (
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div
            className="shrink-0 flex flex-col bg-white border-r border-gray-300 z-10"
            style={{ width: LABEL_W }}
          >
            {/* Header above labels */}
            <div
              className="shrink-0 flex items-end border-b border-gray-300 bg-gray-50"
            ...
            >
              <div className="flex items-center gap-2 px-4 pb-2">
                ...
                <span className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider flex-1">
                  Attività
                </span>
              </div>
            </div>
            ...
            >
              {righe.map((r, i) => (
                ...
                >
                  <span className="text-[10px] text-gray-400 font-mono shrink-0 w-10">
                    {r.wbsCode}
                  </span>
                  <span
                    className={`text-xs truncate flex-1 ${r.isLeaf ? "text-gray-600" : "text-gray-700"}`}
                  >
                    {r.titolo}
                  </span>
                  <span className="text-[10px] text-gray-400 font-semibold shrink-0 w-8 text-right">
                    {r.percentuale}%
                  </span>
                </div>
              ))}
                        ...
                        {barWidth > 50 && (
                          <div className="absolute inset-0 flex items-center px-2 z-10">
                            <span
                              ...
                              style={{
                                color:
                                  r.percentuale > 40 ? "#fff" : colors.text,
                              }}
                            >
                              {r.percentuale}%
                            </span>
